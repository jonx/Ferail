...
/// File-type icon color, picked by extension. Categories chosen for
/// visual differentiation in dense lists, not by file-system semantics.
/// If you need to add an extension, drop it in the obvious match arm.
