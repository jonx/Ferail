//! Archive codec layer: the bytes-move half of Feraille's archive support.
//!
//! `feraille-archive` owns the pure model — the [`Format`] enum, the capability
...
//! [`feraille_core::path_guard::assert_off_ui_thread`], the same tripwire the
...
use feraille_archive::{safe_relative_path, CompressionLevel, Format, Toc};
...
pub fn read_summary(archive: &Path) -> Result<ArchiveSummary, ArchiveError> {
    feraille_core::path_guard::assert_off_ui_thread("archive::read_summary");
    match format_of(archive)? {
...
pub fn extract_all(
    ...
    feraille_core::path_guard::assert_off_ui_thread("archive::extract_all");
...
pub fn extract_entries(
    ...
    feraille_core::path_guard::assert_off_ui_thread("archive::extract_entries");
...
pub fn create_archive(
    ...
    feraille_core::path_guard::assert_off_ui_thread("archive::create_archive");
