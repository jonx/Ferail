...
#[derive(Clone)]
pub enum TableEvent {
    /// A row was clicked with the original click modifiers intact.
    RowClicked {
        row_ix: usize,
        modifiers: Modifiers,
        click_count: usize,
    ...
    D: TableDelegate,
{
    ...
    fn on_cell_click(
        ...
        let should_escalate_to_row =
            !self.row_selector && self.row_selectable && is_reselect && !is_double_click;
            ...
            tr.h_flex()
                ...
                .child(
                    h_flex()
                        ...
                        .relative()
                        .child(
                            super::virtual_list::virtual_list(
                                view,
                                row_ix,
                                Axis::Horizontal,
                                col_sizes,
