...
**Open** (double-click, Enter) opens a recognised archive in the workbench;
Open With hands it to another app. **Open as Archive** is offered for every
other single regular file. It reads and
