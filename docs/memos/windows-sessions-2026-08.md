# Windows sessions, August 2026

← [Documentation map](../README.md) ·
[Windows handover](../testing/WINDOWS_HANDOVER.md) ·
[Windows plan](../features/WINDOWS_COMPATIBILITY_PLAN.md)

The session log extracted from the Windows handover: what each session did,
what it measured, and what it left for the next one. Newest first. Nothing
here is a current statement about the app; for that, read
[STATUS.md](../STATUS.md).
...
the Windows commits: [CHANGELOG.md](../../CHANGELOG.md) and
